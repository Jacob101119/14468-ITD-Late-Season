...
@Autonomous
public final class OZ_3SP extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException{
        ...
        Action moveToSample = robot.drive.actionBuilder(robot.drive.pose)
                ...
                .strafeToConstantHeading(new Vector2d(36, -18))//forward
                .strafeToLinearHeading(new Vector2d(48.5, -18), Math.toRadians(-90))//move to sample
